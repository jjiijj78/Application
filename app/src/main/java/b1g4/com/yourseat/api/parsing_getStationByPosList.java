 ...
 */
  ...
  */
public class parsing_getStationByPosList {
     ...
     */  
    public ArrayList<getStaionsByPosListClass> sendUrltoAPI(String serviceKey, double tmX, double tmY, double radius) {
        ...
        if(tmp==null){
            ...
            ArrayList<getStaionsByPosListClass> result=xmlParsing(tmp);
            return result;
        }        
    }  
    ...
    ArrayList<getStaionsByPosListClass> xmlParsing(NodeList nodeList) {
        ArrayList<getStaionsByPosListClass> result=new ArrayList<>();
        for(int i=0;i<nodeList.getLength();i++){
            ...
            getStaionsByPosListClass tmp=new getStaionsByPosListClass(arsId, dist, gpsX, gpsY, posX, posY, stationId, stationNm, stationTp);
            result.add(tmp);
        }
        return result;
    }     
